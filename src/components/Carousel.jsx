...
export default function Carousel() {
  ...
  return (
    <div className=" flex items-center justify-center ">
        <div className='flex items-center justify-evenly rounded-lg  md:mt-24 mt-10  lg:mt-10 mb-20 hidden ml-[-2] md:flex md:h-56 md:w-[90%] bg-gradient-to-b from-orange-600 to-orange-400  lg:justify-around justify-around gap-[15px] lg:gap-24 '>

          <button>
            <Arrow icon={icon_left} onClick={prev}/>
          </button>  
          <img className='h-56 md:w-40 lg:h-64 self-end ' src={categories[counter]?.character_photo} alt="" />
          <img className='object-cover w-40 md:mx-0 h-56 mx-10 mb-5 self-end rounded-[6px] '  src={categories[counter]?.cover_photo} alt="imagen 2" />
          ...
          <button>
            <Arrow icon={icon_right} onClick={next}/>
            </button>
        </div>
      </div>
