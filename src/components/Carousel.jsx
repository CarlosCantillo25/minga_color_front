...
export default function Carousel() {
    ...
    return (
    <div className="hidden lg:flex justify-center items-center w-full h-80">
        <div className='flex text-white w-[90%] h-[75%] rounded-md bg-gradient-to-b from-orange-600 to-orange-500 justify-around gap-[15px] items-center p-2'>
            ...
            <img className='h-[120%] pb-[35px] w-[230px]' src={categories[counter]?.character_photo} />
            <img className='h-[120%] pb-[30px] rounded-md w-[170px]' src={categories[counter]?.cover_photo} />
