  ...
  return (
    <div className=' bg-[url("/public/Background2.png")] max-sm:bg-[url("/Background1.png")] bg-no-repeat bg-cover  lg:h-[85vh] lg:bg-contain h-[52vh] max-md:h-screen  '>
      ...
      <main  className='flex h-[90vh] md:ml-6 lg:mt-20 lg:ml-14 flex-col max-md:justify-center max-md:items-center lg:gap-2 gap-4 '>
        <h1 className=' text-white md:ml-6  lg:ml-4 max-md:text-center text-[35px] lg:text-[48.8px] font-bold leading-[95.187%] '>For the love of manga</h1>
        <p className='text-white md:ml-6 lg:ml-2 lg:p-2 max-md:text-center text-xl leading-[95.187%]'>Explore our varieties</p>
        <p className='max-md:hidden text-white md:ml-6 lg:ml-5'>#MingaLove❤</p>
        ...
        <div className='max-md:hidden mt-40 w-[96%] h-[225px] rounded-[6px] bg-gradient-to-b from-orange-600 to-orange-400 flex justify-around gap-[10px] items-center'>

          <img className='w-[26px] h-[26px] bg-gradient-to-r from-[#ffff] to-[#ffff] text-[#333333] rounded-xl ' src="/public/flechaizquierda.png" alt="" />

          <img className='w-[253px] h-[261px] max-lg:w-[180px] ' src="/public/imagen1.png" alt="" />

          <img className='h-[300px] pb-[55px] md:h-[280px] rounded-[6px] max-lg:w-[170px]'  src="/public/imagen2.png" alt="imagen 2" />
